...
@section('content')
    <section class="slider">
        <img src="https://img2.goodfon.ru/original/1600x900/c/e7/justice-league-liga.jpg" alt="" class="img-responsive">
        ...
        <div class="slider-informacion">
            <div class="info-pelicula">
                <h1 class="is-size-1-desktop is-size-3-touch has-text-white has-text-weight-bold">LIGA DE LA
                    JUSTICIA</h1>
                <h2 class="is-size-5-touch is-size-4-desktop has-text-white">CIENCIA FICCIÓN ACCIÓN </h2>
                <a class="trailer button is-link is-rounded is-large">Ver Trailer</a>
            </div>
            <div class="fecha">
                <span class="is-size-4-touch is-size-3-desktop has-text-white has-text-weight-normal">Fecha de estreno</span>
                <span class="is-size-5-touch is-size-4-desktop has-text-info has-text-weight-light">15 Oct, 2015</span>
            </div>
        </div>
    </section>
