            ...
            $('.anadir').on('click', function(){
                ...
                $.ajax({
                    ...
                    statusCode:{
                        200: function (e){
                            console.log(e);
                            $callout.text("Productos añadidos.");
...
@section('migas')
    <ol class="breadcrumb">
        ...
        <li class="active">Añadir productos.</li>
    </ol>
@endsection
...
@section('content')
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">Añadir nuevos productos</h3>
        </div>
        <div class="box-body">
            ...
            <p><input type="button" class="anadir sub btn btn-primary" value="Añadir"/></p>
        </div>
    </div>
@stop